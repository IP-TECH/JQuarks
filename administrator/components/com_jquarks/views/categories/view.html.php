<?php
/**
 * JQuarks Component Categories View
 * 
...
class JQuarksViewCategories extends JView 
{
	function display($tpl = null)
	{
        ...
        JSubMenuHelper::addEntry( JText::_( 'CATEGORIES' ), 'index.php?option=com_jquarks&view=categories', true);
		...
		JToolBarHelper::deleteList(JText::_('CONFIRM_SUPPRESSION_CATEGORIES'));
