<?php
/**
 * JQuarks Component Candidates View
 * 
...
class JQuarksViewCandidates extends JView 
{
    function display($tpl = null)
    {
        ...
        JSubMenuHelper::addEntry( JText::_( 'CANDIDATES' ), 'index.php?option=com_jquarks&view=candidates', true);
        JSubMenuHelper::addEntry( JText::_( 'PROFILES' ), 'index.php?option=com_jquarks&view=profiles');
        
        JToolBarHelper::title( JText::_( 'CANDIDATES' ), 'generic.png' );
